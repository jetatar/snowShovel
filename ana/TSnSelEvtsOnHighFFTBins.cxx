...
ClassImp( TSnSelEvtsOnHighFFTBins );
ClassImp( TSnNumHighFFTBins );


TSnSelEvtsOnHighFFTBins::TSnSelEvtsOnHighFFTBins( const Char_t* name ) :
    TAModule(name, "TSnSelEvtsOnHighFFTBins" ), fData(0), fHdr(0), fMeta(0),
...
void TSnSelEvtsOnHighFFTBins::SlaveBegin( )
{
...
void TSnSelEvtsOnHighFFTBins::Process( )
{
    ...
    TSnCalFFTData* fft              = new TSnCalFFTData( "TSnCalFFTData", "", 
                                                                    *fData );
    TSnNumHighFFTBins* nhFFTBins    = new TSnNumHighFFTBins( "highfft", fft );
...
void TSnSelEvtsOnHighFFTBins::Terminate( )
{
}
