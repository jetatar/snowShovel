//
// File generated by /data/users/jtatar/Software/root/bin/rootcint at Sun Jun 22 10:44:03 2014
...
namespace ROOT {
   void TSnNumHighFFTBinsMod_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void *new_TSnNumHighFFTBinsMod(void *p = 0);
   static void *newArray_TSnNumHighFFTBinsMod(Long_t size, void *p);
   static void delete_TSnNumHighFFTBinsMod(void *p);
   static void deleteArray_TSnNumHighFFTBinsMod(void *p);
   static void destruct_TSnNumHighFFTBinsMod(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TSnNumHighFFTBinsMod*)
   {
      ::TSnNumHighFFTBinsMod *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TSnNumHighFFTBinsMod >(0);
      static ::ROOT::TGenericClassInfo 
         instance("TSnNumHighFFTBinsMod", ::TSnNumHighFFTBinsMod::Class_Version(), "./ana/TSnNumHighFFTBinsMod.h", 12,
                  typeid(::TSnNumHighFFTBinsMod), DefineBehavior(ptr, ptr),
                  &::TSnNumHighFFTBinsMod::Dictionary, isa_proxy, 4,
                  sizeof(::TSnNumHighFFTBinsMod) );
      instance.SetNew(&new_TSnNumHighFFTBinsMod);
      instance.SetNewArray(&newArray_TSnNumHighFFTBinsMod);
      instance.SetDelete(&delete_TSnNumHighFFTBinsMod);
      instance.SetDeleteArray(&deleteArray_TSnNumHighFFTBinsMod);
      instance.SetDestructor(&destruct_TSnNumHighFFTBinsMod);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TSnNumHighFFTBinsMod*)
   {
      return GenerateInitInstanceLocal((::TSnNumHighFFTBinsMod*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::TSnNumHighFFTBinsMod*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT

namespace ROOT {
   void TSnPlotNumHighFFTBins_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void *new_TSnPlotNumHighFFTBins(void *p = 0);
   static void *newArray_TSnPlotNumHighFFTBins(Long_t size, void *p);
   static void delete_TSnPlotNumHighFFTBins(void *p);
   static void deleteArray_TSnPlotNumHighFFTBins(void *p);
   static void destruct_TSnPlotNumHighFFTBins(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TSnPlotNumHighFFTBins*)
   {
      ::TSnPlotNumHighFFTBins *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TSnPlotNumHighFFTBins >(0);
      static ::ROOT::TGenericClassInfo 
         instance("TSnPlotNumHighFFTBins", ::TSnPlotNumHighFFTBins::Class_Version(), "./ana/TSnPlotNumHighFFTBins.h", 13,
                  typeid(::TSnPlotNumHighFFTBins), DefineBehavior(ptr, ptr),
                  &::TSnPlotNumHighFFTBins::Dictionary, isa_proxy, 4,
                  sizeof(::TSnPlotNumHighFFTBins) );
      instance.SetNew(&new_TSnPlotNumHighFFTBins);
      instance.SetNewArray(&newArray_TSnPlotNumHighFFTBins);
      instance.SetDelete(&delete_TSnPlotNumHighFFTBins);
      instance.SetDeleteArray(&deleteArray_TSnPlotNumHighFFTBins);
      instance.SetDestructor(&destruct_TSnPlotNumHighFFTBins);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TSnPlotNumHighFFTBins*)
   {
      return GenerateInitInstanceLocal((::TSnPlotNumHighFFTBins*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::TSnPlotNumHighFFTBins*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
TClass *TSnNumHighFFTBinsMod::fgIsA = 0;  // static to hold class pointer

//______________________________________________________________________________
const char *TSnNumHighFFTBinsMod::Class_Name()
{
   return "TSnNumHighFFTBinsMod";
}

//______________________________________________________________________________
const char *TSnNumHighFFTBinsMod::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TSnNumHighFFTBinsMod*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TSnNumHighFFTBinsMod::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TSnNumHighFFTBinsMod*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void TSnNumHighFFTBinsMod::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSnNumHighFFTBinsMod*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *TSnNumHighFFTBinsMod::Class()
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSnNumHighFFTBinsMod*)0x0)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *TSnPlotNumHighFFTBins::fgIsA = 0;  // static to hold class pointer

//______________________________________________________________________________
const char *TSnPlotNumHighFFTBins::Class_Name()
{
   return "TSnPlotNumHighFFTBins";
}

//______________________________________________________________________________
const char *TSnPlotNumHighFFTBins::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TSnPlotNumHighFFTBins*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TSnPlotNumHighFFTBins::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TSnPlotNumHighFFTBins*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void TSnPlotNumHighFFTBins::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSnPlotNumHighFFTBins*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *TSnPlotNumHighFFTBins::Class()
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSnPlotNumHighFFTBins*)0x0)->GetClass();
   return fgIsA;
}
...
//______________________________________________________________________________
void TSnNumHighFFTBinsMod::Streamer(TBuffer &R__b)
{
   // Stream an object of class TSnNumHighFFTBinsMod.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(TSnNumHighFFTBinsMod::Class(),this);
   } else {
      R__b.WriteClassBuffer(TSnNumHighFFTBinsMod::Class(),this);
   }
}

//______________________________________________________________________________
void TSnNumHighFFTBinsMod::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class TSnNumHighFFTBinsMod.
      TClass *R__cl = ::TSnNumHighFFTBinsMod::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*fFFT", &fFFT);
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_TSnNumHighFFTBinsMod(void *p) {
      return  p ? new(p) ::TSnNumHighFFTBinsMod : new ::TSnNumHighFFTBinsMod;
   }
   static void *newArray_TSnNumHighFFTBinsMod(Long_t nElements, void *p) {
      return p ? new(p) ::TSnNumHighFFTBinsMod[nElements] : new ::TSnNumHighFFTBinsMod[nElements];
   }
   // Wrapper around operator delete
   static void delete_TSnNumHighFFTBinsMod(void *p) {
      delete ((::TSnNumHighFFTBinsMod*)p);
   }
   static void deleteArray_TSnNumHighFFTBinsMod(void *p) {
      delete [] ((::TSnNumHighFFTBinsMod*)p);
   }
   static void destruct_TSnNumHighFFTBinsMod(void *p) {
      typedef ::TSnNumHighFFTBinsMod current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::TSnNumHighFFTBinsMod

//______________________________________________________________________________
void TSnPlotNumHighFFTBins::Streamer(TBuffer &R__b)
{
   // Stream an object of class TSnPlotNumHighFFTBins.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(TSnPlotNumHighFFTBins::Class(),this);
   } else {
      R__b.WriteClassBuffer(TSnPlotNumHighFFTBins::Class(),this);
   }
}

//______________________________________________________________________________
void TSnPlotNumHighFFTBins::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class TSnPlotNumHighFFTBins.
      TClass *R__cl = ::TSnPlotNumHighFFTBins::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*fData", &fData);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*fHdr", &fHdr);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*fMeta", &fMeta);
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_TSnPlotNumHighFFTBins(void *p) {
      return  p ? new(p) ::TSnPlotNumHighFFTBins : new ::TSnPlotNumHighFFTBins;
   }
   static void *newArray_TSnPlotNumHighFFTBins(Long_t nElements, void *p) {
      return p ? new(p) ::TSnPlotNumHighFFTBins[nElements] : new ::TSnPlotNumHighFFTBins[nElements];
   }
   // Wrapper around operator delete
   static void delete_TSnPlotNumHighFFTBins(void *p) {
      delete ((::TSnPlotNumHighFFTBins*)p);
   }
   static void deleteArray_TSnPlotNumHighFFTBins(void *p) {
      delete [] ((::TSnPlotNumHighFFTBins*)p);
   }
   static void destruct_TSnPlotNumHighFFTBins(void *p) {
      typedef ::TSnPlotNumHighFFTBins current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::TSnPlotNumHighFFTBins
...
extern "C" void G__set_cpp_environmentG__ana() {
  ...
  G__add_compiledheader("ana/TSnNumHighFFTBinsMod.h");
  G__add_compiledheader("ana/TSnPlotNumHighFFTBins.h");
...
{
   TSnNumHighFFTBinsMod* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new TSnNumHighFFTBinsMod[n];
     } else {
       p = new((void*) gvp) TSnNumHighFFTBinsMod[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new TSnNumHighFFTBinsMod;
     } else {
       p = new((void*) gvp) TSnNumHighFFTBinsMod;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__G__ana_582_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   //m: 2
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new TSnNumHighFFTBinsMod((const Char_t*) G__int(libp->para[0]), (TSnCalFFTData*) G__int(libp->para[1]));
   } else {
     p = new((void*) gvp) TSnNumHighFFTBinsMod((const Char_t*) G__int(libp->para[0]), (TSnCalFFTData*) G__int(libp->para[1]));
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod));
...
{
      G__letint(result7, 104, (long) ((TSnNumHighFFTBinsMod*) G__getstructoffset())->GetNumHighBins((UChar_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__G__ana_582_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((TSnNumHighFFTBinsMod*) G__getstructoffset())->Calculate();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((TSnNumHighFFTBinsMod*) G__getstructoffset())->StreamerNVirtual(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
   TSnNumHighFFTBinsMod* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new TSnNumHighFFTBinsMod(*(TSnNumHighFFTBinsMod*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef TSnNumHighFFTBinsMod G__TTSnNumHighFFTBinsMod;
static int G__G__ana_582_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (TSnNumHighFFTBinsMod*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((TSnNumHighFFTBinsMod*) (soff+(sizeof(TSnNumHighFFTBinsMod)*i)))->~G__TTSnNumHighFFTBinsMod();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((TSnNumHighFFTBinsMod*) (soff))->~G__TTSnNumHighFFTBinsMod();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
{
   TSnNumHighFFTBinsMod* dest = (TSnNumHighFFTBinsMod*) G__getstructoffset();
   *dest = *(TSnNumHighFFTBinsMod*) libp->para[0].ref;
   const TSnNumHighFFTBinsMod& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
   TSnPlotNumHighFFTBins* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
   if (n) {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new TSnPlotNumHighFFTBins[n];
     } else {
       p = new((void*) gvp) TSnPlotNumHighFFTBins[n];
     }
   } else {
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new TSnPlotNumHighFFTBins;
     } else {
       p = new((void*) gvp) TSnPlotNumHighFFTBins;
     }
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__G__ana_583_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   //m: 1
   if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
     p = new TSnPlotNumHighFFTBins((const Char_t*) G__int(libp->para[0]));
   } else {
     p = new((void*) gvp) TSnPlotNumHighFFTBins((const Char_t*) G__int(libp->para[0]));
   }
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins));
...
{
      ((TSnPlotNumHighFFTBins*) G__getstructoffset())->StreamerNVirtual(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
   TSnPlotNumHighFFTBins* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new TSnPlotNumHighFFTBins(*(TSnPlotNumHighFFTBins*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef TSnPlotNumHighFFTBins G__TTSnPlotNumHighFFTBins;
static int G__G__ana_583_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (TSnPlotNumHighFFTBins*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((TSnPlotNumHighFFTBins*) (soff+(sizeof(TSnPlotNumHighFFTBins)*i)))->~G__TTSnPlotNumHighFFTBins();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((TSnPlotNumHighFFTBins*) (soff))->~G__TTSnPlotNumHighFFTBins();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
{
   TSnPlotNumHighFFTBins* dest = (TSnPlotNumHighFFTBins*) G__getstructoffset();
   *dest = *(TSnPlotNumHighFFTBins*) libp->para[0].ref;
   const TSnPlotNumHighFFTBins& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
extern "C" void G__cpp_setup_inheritanceG__ana() {
   ...
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod))) {
     TSnNumHighFFTBinsMod *G__Lderived;
     G__Lderived=(TSnNumHighFFTBinsMod*)0x1000;
     {
       TNamed *G__Lpbase=(TNamed*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod),G__get_linked_tagnum(&G__G__anaLN_TNamed),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod),G__get_linked_tagnum(&G__G__anaLN_TObject),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
   }
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins))) {
     TSnPlotNumHighFFTBins *G__Lderived;
     G__Lderived=(TSnPlotNumHighFFTBins*)0x1000;
     {
       TAModule *G__Lpbase=(TAModule*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins),G__get_linked_tagnum(&G__G__anaLN_TAModule),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
     {
       TTask *G__Lpbase=(TTask*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins),G__get_linked_tagnum(&G__G__anaLN_TTask),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
     {
       TNamed *G__Lpbase=(TNamed*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins),G__get_linked_tagnum(&G__G__anaLN_TNamed),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins),G__get_linked_tagnum(&G__G__anaLN_TObject),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
   }
...
static void G__setup_memvarTSnPlotCorrelations(void) {
   ...
   /* TSnNumHighFFTBinsMod */
static void G__setup_memvarTSnNumHighFFTBinsMod(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod));
   { TSnNumHighFFTBinsMod *p; p=(TSnNumHighFFTBinsMod*)0x1000; if (p) { }
   ...
   /* TSnPlotNumHighFFTBins */
static void G__setup_memvarTSnPlotNumHighFFTBins(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins));
   { TSnPlotNumHighFFTBins *p; p=(TSnPlotNumHighFFTBins*)0x1000; if (p) { }
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__G__anaLN_TSnCalWvData),-1,-1,4,"fData=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__G__anaLN_TSnEventHeader),-1,-1,4,"fHdr=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__G__anaLN_TSnEventMetadata),-1,-1,4,"fMeta=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__G__anaLN_TObjArray),-1,-1,4,"hNHighPks=",0,(char*)NULL);
...
static void G__setup_memfuncTSnNumHighFFTBinsMod(void) {
   /* TSnNumHighFFTBinsMod */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod));
   G__memfunc_setup("TSnNumHighFFTBinsMod",1873,G__G__ana_582_0_1, 105, G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("TSnNumHighFFTBinsMod",1873,G__G__ana_582_0_2, 105, G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod), -1, 0, 2, 1, 1, 0, 
"C - 'Char_t' 10 - name U 'TSnCalFFTData' - 0 - fft", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("Class",502,G__G__ana_582_0_5, 85, G__get_linked_tagnum(&G__G__anaLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TSnNumHighFFTBinsMod::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__G__ana_582_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSnNumHighFFTBinsMod::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__G__ana_582_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TSnNumHighFFTBinsMod::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__G__ana_582_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TSnNumHighFFTBinsMod::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__G__anaLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   ...
   G__memfunc_setup("DeclFileName",1145,G__G__ana_582_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSnNumHighFFTBinsMod::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__G__ana_582_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TSnNumHighFFTBinsMod::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__G__ana_582_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSnNumHighFFTBinsMod::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__G__ana_582_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TSnNumHighFFTBinsMod::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TSnNumHighFFTBinsMod", 1873, G__G__ana_582_0_17, (int) ('i'), G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod), -1, 0, 1, 1, 1, 0, "u 'TSnNumHighFFTBinsMod' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TSnNumHighFFTBinsMod", 1999, G__G__ana_582_0_18, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__G__ana_582_0_19, (int) ('u'), G__get_linked_tagnum(&G__G__anaLN_TSnNumHighFFTBinsMod), -1, 1, 1, 1, 1, 0, "u 'TSnNumHighFFTBinsMod' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}

static void G__setup_memfuncTSnPlotNumHighFFTBins(void) {
   /* TSnPlotNumHighFFTBins */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins));
   G__memfunc_setup("TSnPlotNumHighFFTBins",2000,G__G__ana_583_0_1, 105, G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("TSnPlotNumHighFFTBins",2000,G__G__ana_583_0_2, 105, G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins), -1, 0, 1, 1, 1, 0, "C - 'Char_t' 10 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SlaveBegin",992,(G__InterfaceMethod) NULL, 121, -1, -1, 0, 0, 1, 2, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Process",735,(G__InterfaceMethod) NULL, 121, -1, -1, 0, 0, 1, 2, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Terminate",937,(G__InterfaceMethod) NULL, 121, -1, -1, 0, 0, 1, 2, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Class",502,G__G__ana_583_0_6, 85, G__get_linked_tagnum(&G__G__anaLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TSnPlotNumHighFFTBins::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__G__ana_583_0_7, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSnPlotNumHighFFTBins::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__G__ana_583_0_8, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TSnPlotNumHighFFTBins::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__G__ana_583_0_9, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TSnPlotNumHighFFTBins::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__G__anaLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   ...
   G__memfunc_setup("DeclFileName",1145,G__G__ana_583_0_14, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSnPlotNumHighFFTBins::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__G__ana_583_0_15, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TSnPlotNumHighFFTBins::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__G__ana_583_0_16, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TSnPlotNumHighFFTBins::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__G__ana_583_0_17, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TSnPlotNumHighFFTBins::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TSnPlotNumHighFFTBins", 2000, G__G__ana_583_0_18, (int) ('i'), 
G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins), -1, 0, 1, 1, 1, 0, "u 'TSnPlotNumHighFFTBins' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TSnPlotNumHighFFTBins", 2126, G__G__ana_583_0_19, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__G__ana_583_0_20, (int) ('u'), G__get_linked_tagnum(&G__G__anaLN_TSnPlotNumHighFFTBins), -1, 1, 1, 1, 1, 0, "u 'TSnPlotNumHighFFTBins' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__G__anaLN_TSnNumHighFFTBinsMod = { "TSnNumHighFFTBinsMod" , 99 , -1 };
G__linked_taginfo G__G__anaLN_TSnPlotNumHighFFTBins = { "TSnPlotNumHighFFTBins" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableG__ana() {
  ...
  G__G__anaLN_TSnNumHighFFTBinsMod.tagnum = -1 ;
  G__G__anaLN_TSnPlotNumHighFFTBins.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableG__ana() {
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__G__anaLN_TSnNumHighFFTBinsMod),sizeof(TSnNumHighFFTBinsMod),-1,324864,(char*)NULL,G__setup_memvarTSnNumHighFFTBinsMod,G__setup_memfuncTSnNumHighFFTBinsMod);
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__G__anaLN_TSnPlotNumHighFFTBins),sizeof(TSnPlotNumHighFFTBins),-1,324864,(char*)NULL,G__setup_memvarTSnPlotNumHighFFTBins,G__setup_memfuncTSnPlotNumHighFFTBins);
