...
void diagPlots2(const Char_t* rtfn,
               const Char_t* FPNfn,
               const Char_t* outfn,
...
//   nt->SetBranchAddress("mbChecksum",&mbchksum);
   nt->SetBranchAddress("EventHeader.fNum",&evnum);
   nt->SetBranchAddress("EventHeader.fTime",&utime);
//   nt->SetBranchAddress("unixTimeUS",&utimeus);
   nt->SetBranchAddress("EventHeader.fDTms",&dtms);
