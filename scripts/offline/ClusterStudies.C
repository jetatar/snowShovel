...
// Bounced data
const Char_t* infl      =
"/w2/arianna/DATA/2013_Bounce_Studies/StationData/CombinedCalibTrees/CalTree.RawTree.SnEvtsM0002F7F0C61Ar00042sALL.root";
...
// Bounce studies output.
const Char_t* outfn = "/w2/jtatar/Analysis/Bounce_2014/bnc.r42.pch13.hm4.root";
...
//  Currently only used for bounced studies.
...
//:: Bounced studies module ordering.
    sel->AddInput( besmod );
    besmod->Add( reemod );
    reemod->Add( highffts );
    highffts->Add( ccmod );
