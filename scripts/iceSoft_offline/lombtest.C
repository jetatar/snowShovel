...
void realft(Float_t* const data, const UInt_t n, Int_t isign);
...
void spectrum(DSource_t* br, Num_t* const p, const Int_t m,
   ...
   //
   // 'br' can be either a TBranch or a TH1. for a histogram,
   // 'firstEntry' should be 1, since 0 is the underflow bin.
   //
